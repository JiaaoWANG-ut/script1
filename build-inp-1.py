...
subprocess.call('echo -e "cp2k\n\n0\nq"|Multiwfn *.pdb', shell=True)


dirs=os.listdir("./")

###Find Multiwfn Raw inpfile
for i in dirs:
    if os.path.splitext(i)[1] == '.inp':
        print(i+ " Read Successfully")
        Multiwfn_inpfile=i
        allline=len(open(Multiwfn_inpfile).readlines())
...
print("\n"+filename+".inp"+" Successfully Generated")
